...
})({"cjKxb":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "52bcebafdf702cea";
"use strict";
...
},{}],"ihh80":[function(require,module,exports) {
"use strict";
...
function sortTable(header) {
    ...
    if (!lastHeader || header !== lastHeader) header.dataset.orderType = "ASC";
    tableRows.sort((row1, row2)=>sortRows(row1, row2, header));
    tableRows.forEach((element)=>{
        tbodyElements.append(element);
    });
    header.dataset.orderType = header.dataset.orderType === "ASC" ? "DESC" : "ASC";
    lastHeader = header;
}
function sortRows(row1, row2, header) {
    ...
    if (columnType === "number") {
        if (orderType === "ASC") return Number(value1) - Number(value2);
        return Number(value2) - Number(value1);
    }
    if (columnType === "money") {
        if (orderType === "ASC") return Number(value1.replaceAll("$", "").replaceAll(",", "")) - Number(value2.replaceAll("$", "").replaceAll(",", ""));
        return Number(value2.replaceAll("$", "").replaceAll(",", "")) - Number(value1.replaceAll("$", "").replaceAll(",", ""));
    }
    if (orderType === "ASC") return value1.localeCompare(value2);
    return value2.localeCompare(value1);
}

},{}]},["cjKxb"], null, "parcelRequire0089")

//# sourceMappingURL=sortTable.df702cea.js.map
