...
})({"apdSl":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3f504447f121e4b0";
"use strict";
...
function createForm() {
    ...
    form.append(createSelect("office", "Office: ", [
        "Tokyo",
        "Singapore",
        "London",
        "New York",
...
formElement.addEventListener("invalid", (e)=>{
    if (e.target.name !== "position") return;
    (0, _notificationJs.pushNotification)(10, 10, "Empty position", "Position field cannot be empty.", "error");
}, true);
formElement.addEventListener("submit", (e)=>{
    ...
    if (newPerson.personName.length < 4) {
        (0, _notificationJs.pushNotification)(10, 10, "Short Name", "Name must contain at least 4 characters.", "error");
        return;
    }
    if (newPerson.age < 18 || newPerson.age > 90) {
        (0, _notificationJs.pushNotification)(10, 10, "Wrong age", "Ages must be between 18 and 90.", "error");
        return;
    }
    ...
    (0, _notificationJs.pushNotification)(10, 10, "Success", "A new employee is successfully added", "success");
    formElement.reset();
});

},{"./notification.js":"15efw"}],"15efw":[function(require,module,exports) {
...
},{}]},["apdSl"], null, "parcelRequire0089")

//# sourceMappingURL=form.f121e4b0.js.map
